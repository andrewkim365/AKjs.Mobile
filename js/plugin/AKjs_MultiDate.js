...
(function($){
    ...
    $.fn.AKjs_MultiDate = function(options){
        return new AKjs_MultiDate($(this),options||{});
    };
    $.extend({
        AKjs_MultiDate:function(elem, options){
            return new AKjs_MultiDate($(elem),options||{});
        }
    });
    ...
    function AKjs_MultiDate(elem, opts){
        this.opts = opts;
        this.valCell = elem;
        this.format = this.opts.format;
        this.initdates();
    }
    var jedfn = AKjs_MultiDate.prototype, jefix = "jefixed",matArr = jet.reMatch(regymdzz);
