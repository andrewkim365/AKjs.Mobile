...
-----------------------------------------------------------------------------------------------------------------------
#### 更新时间：2018/08/03 下午 23:05

#### 更新说明：

js目录和css目中 akjs.mobile.js 和 akjs.mobile.css 发布 1.3.8版本；
...
#### 更新时间：2018/08/01 下午 22:35

#### 更新说明：

js目录和css目中 akjs.mobile.js 和 akjs.mobile.css 发布 1.3.7版本；

css目录中 akjs.animate.css 发布1.0.6版本 （修改slideUp和slideDown的动画效果高度计算问题）；
